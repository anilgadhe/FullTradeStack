    ...
    return ( 
        ...
        <div className="container footer mt-6" >
            ...
            <div className="col-12 col-md-12 col-lg-4 ">
                <img src="/media/images/tradeStack.svg" alt="logo_Img" height="50"/>
                <p>© 2024 - 2025, FulltradeStack Broking Ltd.All rights reserved.</p>
                <aside>
            ...
            <div className="col-12 col-md-12 col-lg-2 a-sec ">
             ...
             <a href="#"> Careers </a>
             <a href="#"> FulltradeStack Cares (CSR)</a>
             <a href="#">  FulltradeStack.tech</a>
        ...
        <div className="mt-5">
          <p className="mb-3" style={{fontSize:"13px", color:"grey"}}>FulltradeStack Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through FulltradeStack Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through FulltradeStack Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.: INZ000038238 Registered Address: FulltradeStack Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@FulltradeStack.com, for DP related to dp@FulltradeStack.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
